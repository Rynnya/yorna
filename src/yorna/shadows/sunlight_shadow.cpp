...
namespace yorna {
    ...
    void SunLightShadow::beginRender(const coffee::graphics::CommandBuffer& commandBuffer)
    {
        ...
        commandBuffer.beginRenderPass(renderPass_, framebuffer_, renderArea, depthClearValues.size(), depthClearValues.data());
    ...
    void SunLightShadow::endRender(const coffee::graphics::CommandBuffer& commandBuffer) { commandBuffer.endRenderPass(); }

    DirectionalLight& SunLightShadow::lightObject() noexcept { return sunlight_; }

    Camera& SunLightShadow::camera() noexcept { return sunlightCamera_; }

    coffee::graphics::SamplerPtr SunLightShadow::sampler() const noexcept { return shadowSampler_; }

    coffee::graphics::ImagePtr SunLightShadow::map() const noexcept { return depthMap_; }

    coffee::graphics::ImageViewPtr SunLightShadow::mapView() const noexcept { return depthMapView_; }

    coffee::graphics::PipelinePtr SunLightShadow::pipeline() const noexcept { return pipeline_; }
